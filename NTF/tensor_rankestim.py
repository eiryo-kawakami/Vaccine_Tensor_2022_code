...
rank=10
err_1=calc_denoising_loss(df_3D_trim,na_mask=na_mask_3D_trim,n_rep=50,rank_max=rank,method="MSE") 
...
fig.savefig("CUH_SmartDR_20210727_denoising_mask_rank_estim.pdf")
